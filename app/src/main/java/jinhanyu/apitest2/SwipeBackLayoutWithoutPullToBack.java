...
public class SwipeBackLayoutWithoutPullToBack extends ViewGroup {
    ...
    public SwipeBackLayoutWithoutPullToBack(Context context) {
        this(context, null);
    }

    public SwipeBackLayoutWithoutPullToBack(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void smoothScrollToX(int finalLeft) {
        if (viewDragHelper.settleCapturedViewAt(finalLeft, 0)) {
            ViewCompat.postInvalidateOnAnimation(SwipeBackLayoutWithoutPullToBack.this);
        }
    }
