...
// */
//
//public class NewsBAGRefreshWithLoadView extends BGANormalRefreshViewHolder {
//    boolean mIsLoadingMoreEnabled;
//    boolean mIsRefreshEnabled;
//    private String mPullDownRefreshText ;
//    private String mReleaseRefreshText;
//    private String mRefreshingText;
//
//    public NewsBAGRefreshWithLoadView(Context context, boolean isLoadingMoreEnabled, boolean isRefreshEnabled) {
...
//            this.mRefreshHeaderView = View.inflate(this.mContext, R.layout.header_bga, (ViewGroup)null);
